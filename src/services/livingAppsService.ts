...
import type { Mitarbeiterverwaltung, Schichttypen, Schichtplanung, CreateMitarbeiterverwaltung, CreateSchichttypen, CreateSchichtplanung } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async getMitarbeiterverwaltung(): Promise<Mitarbeiterverwaltung[]> {
    ...
    return hydrateRecords(records, 'mitarbeiterverwaltung');
  }
  static async getMitarbeiterverwaltungEntry(id: string): Promise<Mitarbeiterverwaltung | undefined> {
    ...
    return hydrateRecords([record], 'mitarbeiterverwaltung')[0];
  }
  ...
  static async getSchichttypen(): Promise<Schichttypen[]> {
    ...
    return hydrateRecords(records, 'schichttypen');
  }
  static async getSchichttypenEntry(id: string): Promise<Schichttypen | undefined> {
    ...
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Schichttypen;
    return hydrateRecords([record], 'schichttypen')[0];
  }
  static async createSchichttypenEntry(fields: CreateSchichttypen): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.SCHICHTTYPEN}/records`, { fields: cleanFieldsForApi(fields as any, 'schichttypen') });
    return { ...data, record_id: data.id };
  }
  static async updateSchichttypenEntry(id: string, fields: Partial<CreateSchichttypen>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.SCHICHTTYPEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'schichttypen') });
    return { ...data, record_id: data.id };
  }
  ...
  static async getSchichtplanung(): Promise<Schichtplanung[]> {
    ...
    return hydrateRecords(records, 'schichtplanung');
  }
  static async getSchichtplanungEntry(id: string): Promise<Schichtplanung | undefined> {
    ...
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Schichtplanung;
    return hydrateRecords([record], 'schichtplanung')[0];
  }
  static async createSchichtplanungEntry(fields: CreateSchichtplanung): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.SCHICHTPLANUNG}/records`, { fields: cleanFieldsForApi(fields as any, 'schichtplanung') });
    return { ...data, record_id: data.id };
  }
  static async updateSchichtplanungEntry(id: string, fields: Partial<CreateSchichtplanung>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.SCHICHTPLANUNG}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'schichtplanung') });
    return { ...data, record_id: data.id };
  }
